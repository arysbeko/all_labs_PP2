...
background = pygame.image.load(os.path.join("labs/lab7/images/music elements", "bg2.png"))
...
playb = pygame.image.load(os.path.join("labs/lab7/images/music elements", "play.png"))
pausb = pygame.image.load(os.path.join("labs/lab7/images/music elements", "pause.png"))
nextb = pygame.image.load(os.path.join("labs/lab7/images/music elements", "next.png"))
prevb = pygame.image.load(os.path.join("labs/lab7/images/music elements", "back.png"))
